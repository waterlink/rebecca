// Package pg provides implementation of rebecca driver for postgres. It
// uses github.com/lib/pq and database/sql under the hood.
//
// Enabling this driver for rebecca:
//
// First import both `rebecca` and `pg` in your main.go (or in your test
// suite):
//
// 				import (
...
// https://godoc.org/github.com/waterlink/rebecca/driver/pg/auto
package pg
